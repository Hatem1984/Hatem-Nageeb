(function(root,factory){
  ...
  const CORE_CONTEXT={
    idea_validation:{
      ...
      decision:'هل عندك معيار واضح يقول لك بعد الاختبار: أكمل، أعدّل، ولا أوقف؟'
    },
    first_customer:{
    ...
    pricing:{
      ...
      decision:'هل عندك قاعدة واضحة تقول إمتى تغيّر السعر وإزاي تختبره قبل ما تعممه؟'
    },
    cashflow:{
      ...
      decision:'هل عندك حد أدنى للسيولة أو توقع قريب يقول لك إمتى لازم تتصرف قبل الأزمة؟'
    },
    profitability:{
    ...
    new_branch:{
      ...
      decision:'هل عندك Go/No-Go واضح قبل توقيع عقد أو صرف تجهيزات كبيرة؟'
    },
    new_product:{
